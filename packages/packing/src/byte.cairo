...
impl MaskDowncastFelt252Impl<
    S, +Bounded<S>, +Into<S, u256>, +TryInto<u256, S>,
> of MaskDowncast<felt252, S> {
    fn cast(value: felt252) -> S {
        (Into::<felt252, u256>::into(value) & Bounded::<S>::MAX.into()).try_into().unwrap()
    }
}
